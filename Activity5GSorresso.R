...
#create a season categorical variable 
datD17$seasonC <- 0 
datD17$seasonC <- ifelse(datD16$doy >= 60 & datD16$doy <= 151, 1, datD16$season)
datD17$seasonC <- ifelse(datD16$doy >= 152 & datD16$doy <= 243, 2, datD16$season)
datD17$seasonC <- ifelse(datD16$doy >= 244 & datD16$doy <= 302, 3, datD16$season)
